...
CREATE TABLE UNIT (
	...
	TEL VARCHAR(500),
	MANAGER VARCHAR(500),
	SAVE_MANAGER VARCHAR(500),
	FIRE_HELPER VARCHAR(500),
	HELPER VARCHAR(500),
	AFFAIRS VARCHAR(500)
);
...
CREATE TABLE CONFIG (
	ID BIGINT IDENTITY PRIMARY KEY,
	CFG_KEY VARCHAR(500) NOT NULL,
	CFG_TYPE VARCHAR(500) NOT NULL,
	CFG_NAME VARCHAR(500) NOT NULL,
	CFG_VALUE VARCHAR(500) NOT NULL,
	CFG_MEMO VARCHAR(500) NOT NULL,
	CFG_IN_USE	 INT NOT NULL,
	CREATE_ID VARCHAR(500) NOT NULL,
...
CREATE TABLE CERTIFICATE (
	...
	CERTIFICATE_UNIT VARCHAR(500) NOT NULL,
	GET_DATE DATE NOT NULL,
	GET_FEE INT,
	GET_TRAIN_UNIT VARCHAR(500) NOT NULL,	
...
CREATE TABLE CERTIFICATE_RESPONSIBLE_TIME (
	ID BIGINT IDENTITY PRIMARY KEY,
	ROC_ID VARCHAR(500) NOT NULL,
	CERTIFICATE_ID VARCHAR(500) NOT NULL,
...
CREATE TABLE BATCH_LOG (
	...
	BATCH_RESULT VARCHAR(500) NOT NULL,
...
CREATE TABLE BATCH_SETTING (
	ID BIGINT IDENTITY PRIMARY KEY,
	BATCH_NAME VARCHAR(500) NOT NULL,
	BATCH_CLASS VARCHAR(500) NOT NULL,
	BATCH_TYPE INT,
	BATCH_TYPE_1_TIME Datetime,
