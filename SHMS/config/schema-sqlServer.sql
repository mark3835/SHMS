...
CREATE TABLE CONFIG (
	ID BIGINT IDENTITY PRIMARY KEY,
	CFG_KEY VARCHAR(40) NOT NULL,
	CFG_TYPE VARCHAR(40) NOT NULL,
...
CREATE TABLE CERTIFICATE (
	...
	CERTIFICATE_UNIT VARCHAR(50) NOT NULL,
	GET_DATE DATE NOT NULL,
	GET_FEE INT,
	GET_TRAIN_UNIT VARCHAR(50) NOT NULL,	
...
CREATE TABLE BATCH_LOG (
	...
	BATCH_RESULT VARCHAR(30) NOT NULL,
